...
public class CategoryFinder {
	...
	public static Category getReportCategory(Long guildid) {
		...
		if (catID != null && jda.getCategoryById(catID) != null)
			return jda.getCategoryById(catID);
		...
		cat.getManager().putPermissionOverride(everyone, null, EnumSet.of(Permission.VIEW_CHANNEL,
				...
				Permission.MESSAGE_MENTION_EVERYONE, Permission.MESSAGE_MANAGE, Permission.MESSAGE_HISTORY,
				Permission.MESSAGE_TTS, Permission.VOICE_STREAM, Permission.VOICE_USE_VAD, Permission.PRIORITY_SPEAKER,
				Permission.VOICE_MUTE_OTHERS, Permission.VOICE_DEAF_OTHERS, Permission.VOICE_MOVE_OTHERS)).queue();
