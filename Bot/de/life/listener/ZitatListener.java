	...
	public void onMessageReceived(MessageReceivedEvent event) {
		...
		try {
			if (set.next()) {
				...
				EmbedMessageBuilder.sendMessage("Zitat hinzugef�gt", zitat, Color.GRAY, event.getChannel(), 10);
				LogMessanger.sendLog(event.getGuild().getIdLong(), "Auto-Zitat hinzugef�gt:", zitat);
			}
