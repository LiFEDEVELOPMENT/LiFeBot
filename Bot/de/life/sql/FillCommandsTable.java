...
public class FillCommandsTable {
	...
	public static void fillTable() {
		...
		SQLite.onUpdate("INSERT INTO commands (command) VALUES ('**Musik:**\r\n"
				...
				+ "!queue <YouTube-Link> - Spielt das angegebene Lied bzw. fügt es zur Queue hinzu\r\n"
				+ "!queue <Youtube-Playlistlink> - Spielt die angegebene Playlist bzw. fügt sie zur Queue hinzu\r\n"
